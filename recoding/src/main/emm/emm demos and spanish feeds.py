...
pd_name=201805
demo_feed = "emm_demos_raw_201805.txt"
...
demo_names=["DATA_DATE","panelistid","PANEL_TYPE","PANEL_STATUS","PANEL_ELIGIBILITY","PANEL_SOURCE","AGE",
            ...
            "RACEID","RACEDESC","HISPANICORIGINID","HISPANICORIGINDESC","weight","AGEGROUP","SPANISHLANGUAGE1"]

demo_feed = pd.read_table(r"//usdczgk842/Fusion/TV_Dig/RDD_Digital/EMM_Feeds/raw/" + str(pd_name) + "/" + str(demo_feed), 
...
demo_feed5 = demo_feed4[["MOBILEID", "panelistid", "GENDER", "weight", "OS",
               "ZIPCODE",  "AGE", "educationid", "INCOMEID", "employmentid", "RACEID", "hispanicid", "ETHNIC_IDENTITY_CODE"]]
...
#export to csv
demo_feed7.to_csv(os.path.join("//usdczgk842/Fusion/TV_Dig/RDD_Digital/EMM_Feeds/sas_input/" + str(pd_name),"emm_phn_demos_raw_" +  str(pd_name) +".csv"),index=False)
...
#export to csv
demo_feed7.to_csv(os.path.join(r"//usdczgk842/Fusion/TV_Dig/RDD_Digital/EMM_Feeds/sas_input/" + str(pd_name),"emm_tab_demos_raw_" +  str(pd_name) +".csv"),index=False)
